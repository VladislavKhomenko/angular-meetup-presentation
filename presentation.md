...
2. **Проблемы без class-transformer**
3. **Решение с class-transformer**
4. **Кастомные декораторы MapTo и MapListTo**
5. **Helper mapInstanceToPlain**
6. **Практические примеры из production проектов**
7. **Лучшие практики**

---

## Слайд 3: Что такое DTO?
...
## Слайд 4: Проблемы без class-transformer
...
## Слайд 5: Решение с class-transformer
...
## Слайд 6: Основные декораторы class-transformer
...
## Слайд 7: Кастомные декораторы MapTo и MapListTo
...
## Слайд 8: Использование в сервисах
...
## Слайд 9: Helper mapInstanceToPlain
...
## Слайд 10: Модель User - реальный пример
...
## Слайд 11: Модель Account - сложный пример
...
## Слайд 12: EntityList - работа с пагинацией
...
**Q: Совместимость с Angular?**
A: Отлично работает, никаких проблем
